...
[_BASE] = LAYOUT(
  ...
  KC_H,     KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_NO,   KC_NO,
  KC_N,     KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,  KC_UP,   KC_NO,
  KC_SPC,   MO(_FN), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,   KC_NO
),
};